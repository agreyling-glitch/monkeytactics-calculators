...
The site currently features 32 tools organized around the hierarchy used by the universal menu and All Tools directory:
...
| **Text & Data** | — | Unit Converter, Tip Calculator, QR Code Decoder, Word Unscrambler, Words With Friends Solver, Crossword Solver, Wordle Solver, Quordle Solver, Word & Character Counter, OCR Utility |

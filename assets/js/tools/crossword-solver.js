...
(function initializeCrosswordSolver() {
  ...
  const OFFLINE_CORE_URLS = [
    ...
    "/assets/wasm/menu/menu.js?v=20260915-menu-manifest-v2",
    "/assets/wasm/menu/menu.css?v=20260915-menu-manifest-v2",
    "/assets/wasm/menu/menu_bg.wasm?v=20260915-menu-manifest-v2",

/* @ts-self-types="./anagram_architect_engine.d.ts" */
 ...
 */
export function init_engine(dictionary) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.init_engine(retptr, addHeapObject(dictionary));
 ...
 * @param {any} records
 */
export function init_language_metadata(records) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.init_language_metadata(retptr, addHeapObject(records));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
 ...
 * @param {any} records
 */
export function init_language_model(records) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.init_language_model(retptr, addHeapObject(records));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
 ...
 * @param {any} options
 */
export function start_search(source, options) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.start_search(retptr, ptr0, len0, addHeapObject(options));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
 ...
 * @returns {any}
 */
export function step_search(node_budget) {
    const ret = wasm.step_search(node_budget);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./anagram_architect_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('anagram_architect_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

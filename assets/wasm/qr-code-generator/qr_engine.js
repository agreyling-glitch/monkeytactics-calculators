 ...
 * @returns {any}
 */
export function batch_generate(list) {
    const ret = wasm.batch_generate(addHeapObject(list));
 ...
 * @returns {Uint8Array}
 */
export function export_pdf() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.export_pdf(retptr);
 ...
 * @returns {Uint8Array}
 */
export function export_png(dpi) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.export_png(retptr, dpi);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export4(r0, r1 * 1, 1);
 ...
 * @returns {any}
 */
export function generate_qr(data) {
    const ret = wasm.generate_qr(addHeapObject(data));
    return takeObject(ret);
}
 ...
 * @returns {any}
 */
export function style_qr(options) {
    const ret = wasm.style_qr(addHeapObject(options));
    return takeObject(ret);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('qr_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

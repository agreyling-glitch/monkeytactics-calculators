...
export class AnalysisResult {
     ...
     */
    get char_count() {
        const ret = wasm.analysisresult_char_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get char_no_spaces() {
        const ret = wasm.analysisresult_char_no_spaces(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {any}
    ...
    get keyword_frequency() {
        const ret = wasm.analysisresult_keyword_frequency(this.__wbg_ptr);
     ...
     */
    get ngram_data() {
        const ret = wasm.analysisresult_ngram_data(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {number}
     */
    get paragraph_count() {
        const ret = wasm.analysisresult_paragraph_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {any}
     */
    get readability_scores() {
        const ret = wasm.analysisresult_readability_scores(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {number}
     */
    get sentence_count() {
        const ret = wasm.analysisresult_sentence_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {any}
     */
    toJSON() {
        const ret = wasm.analysisresult_toJSON(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {any}
     */
    get top_keywords() {
        const ret = wasm.analysisresult_top_keywords(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {any}
    ...
    get visualization_data() {
        const ret = wasm.analysisresult_visualization_data(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {number}
     */
    get word_count() {
        const ret = wasm.analysisresult_word_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
 ...
 */
export function analyze_text(input) {
 ...
 * @returns {AnalysisResult}
 */
export function analyze_text_with_segments(input, segments) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.analyze_text_with_segments(retptr, ptr0, len0, addHeapObject(segments));
        ...
        return AnalysisResult.__wrap(r0);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('text_analyzer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

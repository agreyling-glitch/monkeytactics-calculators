/* @ts-self-types="./word_unscrambler_engine.d.ts" */

/**
 * @param {string} word
 * @returns {any}
 */
export function analyze_word(word) {
    const ptr0 = passStringToWasm0(word, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.analyze_word(ptr0, len0);
 ...
 * @returns {any}
 */
export function board_fit_analysis(rack, pattern, options) {
    const ptr0 = passStringToWasm0(rack, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(pattern, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.board_fit_analysis(ptr0, len0, ptr1, len1, addHeapObject(options));
    return takeObject(ret);
}
 ...
 * @returns {any}
 */
export function find_hooks(word) {
    const ptr0 = passStringToWasm0(word, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.find_hooks(ptr0, len0);
    return takeObject(ret);
}
 ...
 * @returns {any}
 */
export function find_hooks_for_dictionary(word, dictionary_bit) {
    const ptr0 = passStringToWasm0(word, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.find_hooks_for_dictionary(ptr0, len0, dictionary_bit);
    return takeObject(ret);
}
 ...
 * @param {any} dictionary_json
 */
export function init_engine(dictionary_json) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.init_engine(retptr, addHeapObject(dictionary_json));
 ...
 * @returns {any}
 */
export function unscramble(rack, pattern, options) {
    const ptr0 = passStringToWasm0(rack, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(pattern, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.unscramble(ptr0, len0, ptr1, len1, addHeapObject(options));
    return takeObject(ret);
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./word_unscrambler_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('word_unscrambler_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();

/* @ts-self-types="./blown_insulation_engine.d.ts" */
 ...
 * @returns {string}
 */
export function calculate(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function load_coverage_chart(json_string) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.load_coverage_chart(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./blown_insulation_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('blown_insulation_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
